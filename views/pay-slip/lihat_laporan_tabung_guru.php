...
$this->params['breadcrumbs'][] = ['label' => 'Laporan Kewangan', 'url' => ['laporan_tabung_guru']];
        ...
        <div class="portlet light bordered ">
            <div class="portlet-title">
                <div class="caption font-green-haze">
                    <i class="icon-calendar"></i>Laporan Tabung Guru <?php echo date("F Y",strtotime($tarikhmasa)); ?>
                </div>
                <div class="actions">
                    <?= Html::a('Cetak <i class="fa fa-print"></i>', ['lihat_laporan_tabung_guru','tahun'=>$tahun,'bulan'=>$bulan,'cetak'=>'cetak'], ['class' => 'btn dark btn-outline btn-sm','target'=>'_BLANK']) ?>
                </div>
            </div>
            <center>
            <?php $form = ActiveForm::begin([
            	'action' => ['lihat_laporan_tabung_guru'],
            	'method' => 'GET',
            	'options' => [
    		...
    		<div class="portlet-body">
                ...
                <?php 
                    $total = 0;
                        for($i=0;$i<$bil;$i++)
                        {
                            $total = $total + round($tabung_guru[$i],2);
                        }
                ?>
                    <tr>
    			...
    			<tbody>
                    ...
                    <tr>
                        ...
                        <td><?= $nama[$i] ?></td>
                        <td><?= $no_kp[$i] ?></td>
                        <td><?= number_format($tabung_guru[$i],2) ?></td>
                    </tr>
