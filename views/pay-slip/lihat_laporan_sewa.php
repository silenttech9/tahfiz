...
$this->params['breadcrumbs'][] = ['label' => 'Laporan Kewangan', 'url' => ['laporan_sewa']];
        ...
        <div class="portlet light bordered ">
            <div class="portlet-title">
                <div class="caption font-green-haze">
                    <i class="icon-calendar"></i>Laporan Sewa Rumah <?php echo date("F Y",strtotime($tarikhmasa)); ?>
                </div>
                <div class="actions">
                    <?= Html::a('Cetak <i class="fa fa-print"></i>', ['lihat_laporan_sewa','tahun'=>$tahun,'bulan'=>$bulan,'cetak'=>'cetak'], ['class' => 'btn dark btn-outline btn-sm','target'=>'_BLANK']) ?>
                </div>
            </div>
            <center>
