                ...
                <div class="tools actions">
                    ...
                    <div class="btn-group">
                        ...
                        <ul class="dropdown-menu pull-right">
                            <li>
                                <?= Html::a('<i class="fa fa-plus"></i><span class="hidden-xs">Tambah Kakitangan </span>', ['create'], ['class' => '']) ?>
                            </li>
                            <li>
                                <?= Html::a('<i class="fa fa-print"></i><span class="hidden-xs">Print </span>', ['printstaff'], ['class' => '','target'=>'_BLANK']) ?>
                            </li>
                        </ul>
                    </div>
